            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mt-3">
                        ...
                        <div class="form-check">
                            <input name="jenisKamar" class="form-check-input" type="radio" value="Deluxe" id="deluxe">
                            <label class="form-check-label" for="deluxe">
                                Deluxe (Rp.1.000.000)
                            </label>
                        </div>
                        <div class="form-check">
                            <input name="jenisKamar" class="form-check-input" type="radio" value="Premium" id="premium">
                ...
                <div class="col-md-6">
                    <div class="mt-3">
                        ...
                        <div class="form-check">
                            <input name="smoking" class="form-check-input" type="checkbox" value="" id="smoking">
                            <label class="form-check-label" for="smoking">
                                Include Smoking Room (Rp.200.000)
                            </label>
                        </div>
                        <div class="form-check">
                            <input name="breakfast" class="form-check-input" type="checkbox" value="" id="breakfast">
